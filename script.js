...
const figures = {
  ...
  gandalf: {
    name: "Gandalf",
    power: "teleport",
    description: "Teleporteert naar de portal.",
    color: "#9c27b0"
  },
  robot: {
    name: "Robot",
...
function init3D() {
  ...
  portal.position.set(2.5, 0.01, -2.5);
  scene.add(portal);
...
function updatePlayer(delta) {
  ...
  if (distToPortal < 0.8 && canTeleport) {
    player.position.set(-2.5, 0.5, 2.5);
  }
}
